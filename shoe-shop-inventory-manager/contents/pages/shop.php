...
$customers = $db->arraybuilder()->paginate("shop", $page, $select);
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="page-action-links text-right">
	            <a href="../operations/add_data.php?operation=create&table=shop">
	            	<button class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add shop</button>
	            </a>
            </div>
        </div>
    </div>
	...
	<div class="text-center">
        ...
        if ($total_pages > 1) {
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                ...
                echo '<li' . $li_class . '><a href="shop.php' . $http_query . '&page=' . $i . '">' . $i . '</a></li>';
            }
            echo '</ul></div>';
        }
        ?>
