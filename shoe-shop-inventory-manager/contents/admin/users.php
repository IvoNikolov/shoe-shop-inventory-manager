...
$db = getDbInstance();
$select = array('id', 'user_id','email','first_name', 'last_name', 'role');
$real_names = array('id' => '#',
					'user_id' => 'User ID',
					'email' => 'Email',
...
$customers = $db->arraybuilder()->paginate("users", $page, $select);
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="page-action-links text-right">
	            <a href="../admin/add_user.php?operation=create">
                ...
                <tbody>
                    <?php foreach ($customers as $row):?>
                        <tr>
        	                ...
        	                <td>
        					<a href="../admin/edit_user.php?user_id=<?php echo $row['id'] ?>&operation=edit&table=users" class="btn btn-primary" style="margin-right: 8px;"><span class="glyphicon glyphicon-edit"></span>
        					      ...
        					      <!-- Modal content-->
        						      <div class="modal-content">
        						        ...
        						        <div class="modal-body">
        						        		...
        						        		<input type="hidden" name="del_table" id ="del_table" value="users">
